...
import {
  ...
  Users, BarChart3, Plug, LogOut, PanelLeft, ChefHat, Upload, ClipboardList, UtensilsCrossed, TrendingUp, LineChart, Mail, DollarSign, ListChecks, Landmark, Store, BookOpen, BookMarked, Timer
} from "lucide-react";
...
const menuItems = [
  ...
  { icon: FileText, label: "Invoices & AP", path: "/invoices" },
  ...
  { icon: UtensilsCrossed, label: "Menu Items", path: "/menu-items" },
  { icon: TrendingUp, label: "Product Sales", path: "/product-sales" },
  ...
  { icon: BookMarked, label: "Revenue Pipeline", path: "/revenue-pipeline" },
  { icon: Timer, label: "AP Aging", path: "/ap-aging" },
      ...
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-center">Hinnawi Ops OS</h1>
            ...
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  <span className="font-bold tracking-tight truncate text-foreground">Hinnawi Ops</span>
                </div>
              )}
            </div>
          </SidebarHeader>
